(function () {
  ...
  const defaultMessage = 'The Mothership is recalibrating this sector. New transmission incoming — check back soon.';
    ...
    try {
      ...
      if (response.ok) {
        ...
        state = {
          ...
          message: String((data && data.message) || defaultMessage).slice(0, 240)
        };
      } else {
